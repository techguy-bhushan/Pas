package com.playwithspring.part1.chapter2.di.wirecollection.list;
...
public class TestCricketPlayerService {
    public static void main(String[] args) {
        ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext("file:src/main/java/com/playwithspring/part1/chapter2/di/wirecollection/list/application_context.xml");
